<!-- Logo -->
<h1 align="center">
  On the Metal Transcripts
</h1>

<!-- Copy -->
<h4 align="center">Transcripts and summaries generated from the On the Metal podcast episodes through OpenAI Whisper, Llama 3.1, and LanguageTool.</h4>

<!-- Badges -->
<div align="center">
  <!-- Issues -->
  <img alt="GitHub Issues" src="https://img.shields.io/github/issues/willtheorangeguy/On-the-Metal-Transcripts">
  <!-- Pull Requests -->
  <img alt="GitHub Pull Requests" src="https://img.shields.io/github/issues-pr/willtheorangeguy/On-the-Metal-Transcripts">
  <!-- Discord -->
  <img alt="Discord Server ID" src="https://img.shields.io/discord/1382526731528962088">
  <!-- Language Count -->
  <img alt="GitHub Languages" src="https://img.shields.io/github/languages/count/willtheorangeguy/On-the-Metal-Transcripts">
</div>
...
**To clone and run your own copy of this website**, you'll need [Git](https://git-scm.com/downloads), [Ollama](https://ollama.com/) and a bunch of Python libraries installed on your computer. If you would rather not use Git, you can just download the code from GitHub [above](https://github.com/willtheorangeguy/On-the-Metal-Transcripts/archive/refs/heads/main.zip). From your command line:

```bash
# Clone this repository
$ git clone https://github.com/willtheorangeguy/On-the-Metal-Transcripts.git

# Go into the repository
$ cd On-the-Metal-Transcripts
...
If support is required, please open a **[GitHub Discussion](https://github.com/willtheorangeguy/On-the-Metal-Transcripts/discussions/new)** or join our **[Discord](https://discord.gg/mgbda4fesN)**.

## Contributing

Please contribute using [GitHub Flow](https://guides.github.com/introduction/flow). Create a branch, add commits, and [open a pull request](https://github.com/willtheorangeguy/On-the-Metal-Transcripts/compare).
...
<table>
  <tr>
    ...
    <th align="center"><img src="https://cdn.brandfetch.io/idyc-dT_7Q/w/400/h/400/theme/dark/icon.jpeg?c=1bxid64Mup7aczewSAYMX" width="150" height="150" alt="Oxide"/></th>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td align="center"><a href="https://oxide.computer/">Web</a></td>
  </tr>
</table>
