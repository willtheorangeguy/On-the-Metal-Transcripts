...
On the Metal Podcast Transcripts GitHub repository. 
"""
import os
import zipfile
import requests
...
def unzip_file(zip_path):
    ...
    extracted_folder = os.path.join(cwd, "On-the-Metal-Transcripts-main")
    if os.path.exists(extracted_folder):
        new_folder_name = "On-the-Metal-Transcripts"
...
if __name__ == "__main__":
    ...
    url = "https://github.com/willtheorangeguy/On-the-Metal-Transcripts/archive/refs/heads/main.zip"
    output_zip = "on_the_metal_transcripts.zip"
