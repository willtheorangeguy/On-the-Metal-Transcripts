...
• Cache behavior and its potential for abuse
...
• The speaker mentions a personal anecdote about discussing the issue with their sister while trying to choose wedding dresses
...
• The speaker's collection of esoteric machines, including PA Risk, Itanium, and other vintage computers
• HP's Itanium was codenamed McKinley
• The speaker wanted to codename a similar project "Zolgaas" after Leon Zolgaas, Kinley's assassin
• Discussion of the codenames and their meanings
• Explanation of how Itanium's speculation instructions work under programmer control
...
• Red Hat's engineering headquarters is in Westford, Mass.
...
• Speculative execution analysis of old machines, including Alpha and Itanium architectures
...
• Discussion of Itanium's performance, particularly its success in spec benchmarks except for GCC
...
• Mention of Heartbleed as a significant vulnerability that needed marketing
...
• FDIF bug in Pentium processors from 25 years ago
• Incorrect results due to FDIF's algorithm and lookup table issue
• Intel had fixed the problem by new silicon, but it existed in older chips
• FDIF was reproducible with a specific Excel spreadsheet calculation
• Mention of microcode and tricks behind the scenes in modern x86 machines
• FOOF bug: an illegal instruction prefix that caused hard hangs
• Mitigation for FOOF: unmapping first six entries of IDT or aligning it properly
...
• Booting a cartridge with Uboot and loading a modified firmware over the network
...
• The project eventually landed in Cavium's Thunder X2 platform
• The speaker played a significant role in persuading assets to land in Cavium and helped the design team continue working on the project from their Airbnb 
...
• Discussion of Corboot supporting K-Exec of Windows as an alternative
...
• Adoption of open source firmware, specifically TianaCore project
• Contributing changes directly to the TianaCore project
• Importance of open-source in UEFI and other embedded bootloaders like Uboot
...
• Criticism of the use of nanometer measurements as a marketing tool rather than an actual measurement
• Explanation that current technology is not actually at the claimed nanometer scale
...
• The limitations of third-party fabbing services and its implications for market share
...
• Carbon nanotube-based memory from companies like Nantero
...
• Concerns about heat generation and its impact on data centers
...
• The speaker's past experience in inventing non-existent technology to test people's reactions
