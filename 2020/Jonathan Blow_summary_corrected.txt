...
• Texture mapping and vertex coordinates for colour and image variation
...
• Behaviour of physics equations varying based on update rate
...
• GPUs require many threads to function efficiently
...
• Clock speeds levelling off in the early 2000s
• Introduction of the PlayStation 3 and its Cell processor
• Discussion of Menard scaling and its limitations
• Comparison of the Cell processor's design to the Xbox 360's architecture
• Mention of Dahl's law and its implications for parallel processing
...
• Independence of pixel math from neighbouring pixels
...
• Games take advantage of this instinctual behaviour, making controls feel natural and intuitive
• The speaker discusses how latency can break this instinctual behaviour, making actions feel unnatural and frustrating
...
• The speaker's favourite childhood game was Trinity, a text adventure game by Infocom
...
• The speaker's favourite game in college was Net Track, a client-server game that was similar to playing football with Star Trek ships.
...
• Porting of Doom to a specific system (Unix) and the WON file
...
• The game was developed by John Carmack and Mike Brash, who later shared their techniques at industry conferences
...
• Complexity of modern CPUs and the difficulty of understanding their behaviour
...
• Game engine entities as an example of entities with associated data and behaviour
...
• The speaker mentions a presentation at Rust Con 2018 about the entity component system
...
• Discussing the "open parent, close parent" issue in C
• Recounting a experience with C and its optional function signatures
...
• Discussion of the difficulties in programming for different platforms (e.g. Linux, Windows) due to different shading languages (e.g. OpenGL, Vulcan, DirectX)
...
• The idea that higher-level languages provide more power and inexpressibility to programmers, abstracting them from low-level details, is explained.
• A conflation occurred in the 1990s, where the concepts of higher-level languages, power, inexpressibility, and distance from the CPU became conflated, leading to the development of languages that were more about being far from the CPU rather than actual power and inexpressibility.
...
• Problem of initialized variables and crashes
...
• Software for brain stem and core game engine development is written by a relatively small number of programmers.
...
• Unix philosophy and other abstractions (such as Rust and Set) offer simplicity and importance
