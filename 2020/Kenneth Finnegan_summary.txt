...
• The friend, Javier, suggested that the speaker start his own ISP, citing the proximity of his own data center to Hurricane Electric's campus
...
• Illicit cabling is a common problem in data centers, with some businesses even going so far as to drill through floors to save money on cross-connect fees
• Breaking into data centers at night with a concrete drill or hammer drill to avoid detection
• Smuggling cables and equipment into data centers
• Setting up secret internet exchanges within data centers
• Disguising oneself as a legitimate employee to gain access to data centers
...
• The Kenneth net, also known as the "FJX" (pronounced "fuck X"), is an internet exchange that is growing and becoming legitimate.
• The exchange has 50 networks connected, with a peak traffic of 6-7 gigabits per second.
