# On the Metal Transcripts — Documentation

This archive holds machine-generated transcripts and summaries for the On the Metal podcast episodes, together with the pipeline that produces them. The pipeline runs as 5 numbered stages; `main.py` executes them in order.
