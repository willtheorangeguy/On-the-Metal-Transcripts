# On the Metal Transcripts — Pipeline
...
|---|---|---|---|
| 1 | `1_download.py` | This script uses yt-dlp to download audio, by year, from the On the Metal podcast playlist. | — |
...
| 3 | `3_transcriber.py` | This script transcribes audio files from the On the Metal podcast episodes using OpenAI's Whisper model. | `transcribed.log` |
