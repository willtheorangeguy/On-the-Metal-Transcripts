• Introduction to Ron Minnick and his role as the "godfather of open firmware"
...
• Collaboration with other experts in the field, including Stefan Reinhauer and Ying Hai Liu, to overcome technical challenges
...
• The importance of open source repositories like Linux, BIOS, and Coreboot
• Open source community and social networking
• Exhaustion with pull requests and commercialization of open source
• Uroot project goals: simplify build process and make systems more accessible
...
• Built relay computers and later leased HP 2100 machine from LeaseCo
• Used ASR 33 paper tape punch and reader
• Had Dr. Nim, a plastic device that played the game of Nim using marbles as input bits
• Worked with other digital devices from ESR company, including Thinkadot and Digicomp
• Learned Boolean algebra and Oregon's theorem through Digicomp
• The speaker's first exposure to computers was through the Digicomp 1 and Dr. Nim
• They mention ESR (Electronic Systems Review) and Wikipedia as resources for learning about early computer history
• The Geniac, a pre-computer device that used logic equations and plug boards, is mentioned as another early influence
...
• Bad memories about Linux, BIOS, and BPROC from past issues with cluster systems
• Eric implemented a scheduler that took advantage of his BPROC ideas and significantly improved cluster performance
• Mirror Net and its development by Chuck Seitz
...
• Most companies, including Mellanox, now use a similar underlying technology to IB but label it as Ethernet
• The FI (fabric interface) used by many networks was originally licensed from Dolphin and has since been widely adopted
• IB itself is complex and difficult to configure, leading to humor about its adoption by national labs due to their access to postdocs who could handle the setup
• Discussion of difficulties with Infiniman and the Linux kernel patch
...
• Chromebooks have popularized core boot for mainstream computers
...
• Chromebooks have a high degree of configurability
• The ability to rekey a Chromebook with personal keys and build an operating system image
...
• Chromebooks have improved significantly since their early days, now offering high-quality hardware and a pleasant user experience
...
• The speaker mentions the benefits of being able to install custom operating systems on Chromebooks, including Nychrome OS and Web Boot.
• They discuss how Chromebooks can discourage experimentation with custom software due to restrictive boot requirements.
• The speaker notes that some interns have successfully installed non-Chrome OS operating systems on Chromebooks.
• Discussion of stateless laptops and devices
• Joanna Rakowska's Tails machine and Chromebook/web boot potential
...
• UEFI preboot network stack issue with DMA causing corruption in RAM
...
• The conversation shifts to discussing Chromebooks and open firmware, specifically in relation to the server space.
...
• Decapping and chip analysis can reveal vulnerabilities for exploitation by malicious actors.
...
• The ultimate aim is to create a world where servers are designed for recyclability and refurbishment.
...
• Introducing Orboot, a downstream fork of Corboot without C code
• Using Rust to write firmware code for Orboot
• Loading kernels on the RISC-V-based sci-fi five freedom U board using Orboot
• Compiling Orboot for the open Titan and finding bugs in the Rust code
...
• OpenTitan and Linux not being used
