...
• Andy Bechtelsheim's approach to hardware design was discussed, including his belief that the processor could handle address incrementation
...
• Data Point's claim to having invented the microprocessor, personal computer, and local area network (ARCnet) was discussed
• Kunix's growth on ARCnet and its later support for the technology
...
• The use of AppleTalk in devices like the Mac and LaserRider
...
• Comparison of file-based (NFS) vs block-based storage protocols (Fiber Channel, iSCSI)
...
• Van Jacobson's congestion theorem-based exponential backoff solution
...
• Description of hacking a VME bus to PCAT bus adapter for the Sun 4
...
• History of token ring: IBM, Proteon, FDDI (100 megabit optical), ARCnet, etc.
...
• Porting Unix to mainframes at Amdahl
...
• Work on APL 360 timesharing system at Princeton Computer Center, including operating an APL keyboard with custom font and characters
...
• Computer center reacted negatively, not knowing about Unix or PDP systems
...
• The speakers reminisce about working at Bell Labs and encountering talented individuals such as Greg Chesson
• Discussion about Joseph Osana's death and the possible circumstances surrounding it
• Mention of Brian Carnahan's book on Enroff and its potential explanation for some of the code's mysteries
• Porting of Enroff from Assembler to other languages and platforms
• Analysis of Enroff's code, which contains "magic numbers" and appears to be loosely typed
• Story about Brian Carnahan's experience trying to modernize Enroff and its surprising complexity
...
• Porting Unix to mainframes at Amdahl
• Interview process and arrival at Amdahl in 1978
• Silicon Valley allure attributed to good weather
• Consulting on Unix project for Amdahl, using deck tapes
• The speaker visits a computer museum and is amazed by the preservation of old computers from the 1970s.
• Amdahl Corporation's early work with Unix, including version 6, which was still in development when they started using it.
• Writing device drivers for IBM terminals under Unix, particularly for the IBM 3270 terminal.
• The challenge of adapting Unix to run on Amdahl mainframes due to their record-oriented architecture and the need to avoid disturbing the mainframe unless necessary.
• How Amdahl Corporation initially used Unix as a time-sharing system for electronic design automation people before integrating it into their operating systems.
• Development of UTS (Unix Time-Train System) and its popularity in the Bell system and universities.
• The speaker's departure from Amdahl Corporation due to a "crazy company" that was starting, which turned out to be Sun Microsystems.
• The speaker's experience working with Bill Joy and being part of the West Coast Unix universe
• Being recruited by Scott McNeely to join a startup related to the Sun board
...
• Comparison with the rollerball mouse
• Reliability and precision advantages of the optical mouse
• Independent development of the optical mouse by two individuals
• Early use of color laser printers in Xerox technical reports
• Timeline for the invention and introduction of the optical mouse (1980s)
• Differences between various optical mice technologies, including orientation dependence and grid patterns on the mousepad
...
• Ipsilon proposed operating ATM switches with IP routing to create "IP switching" and faster speeds.
...
• Ipsilon (a company) and its sale to Nokia
...
• Confusion over what Nokia wanted from Ipsilon, with a focus on IP routing expertise instead of ATM
...
• The speaker's work after leaving Nokia, including consulting, playing with Linux, and starting another startup called Netillion
• The discussion appears to be about a computer company called Nuova and its history.
• A team of engineers, including MPLS (Mario, Prim, Luca, and Sony), left Cisco to start Nuova in the early 2000s.
• The speaker was involved with Nuova as a co-founder.
...
• The formation of Nuova Systems and its acquisition by Cisco
...
• Nuova's complex system design, including local switches and fabric extenders
• DriveScale time and investment in peace at Cisco
...
• Introduction to DriveScale and its goals for server simplicity
• Mention of a podcast hosted by Tom Lyon and invitation to learn more about DriveScale through it
